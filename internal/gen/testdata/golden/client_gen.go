...
// Package widget is the Widget API.
//
// A fixture service, used to pin the generator's output.
//
...
// New builds a widget client from a shared configuration.
//
